...
<!--Verification of User Account if login-->
<?php
...
?>
	...
	<body>
		...
		<div class="container">
			...
			<br /><br />
			<?php
				$query = "SELECT * FROM table_products WHERE active_status='Yes'";
			...
			<div class="col-md-4">
				<form method="post" action="products.php?action=add&id=<?php echo $row["id"]; ?>">
					<div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">
						<img src="image/product-img/<?php echo $row["image_name"]; ?>" class="img-responsive" /><br />
