...
<?php
	...
	<section class="items">
	<div class="container">
	<h2 class="text-center">Seafood Products</h2>
	<div class="navbar">
				<div class="menu">
					<ul>
						<li>
	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["shopping_cart"] as $keys => $values)
		{
			if($values["item_id"] == $_GET["id"])
			{
				...
				echo '<script>window.location="seafood.php"</script>';
			}
		}
	}
}
...
?>
	...
	<body>
		...
		<div class="container">
			...
			<br /><br />
			<?php
				$query = "SELECT * FROM table_products WHERE active_status='Yes' AND description='Fish' ";
				...
				?>
			<div class="col-md-4">
				<form method="post" action="seafood.php?action=add&id=<?php echo $row["id"]; ?>">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="seafood.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
					<?php
