...
<?php
	...
	<section class="items">
	<div class="container">
	<h2 class="text-center">Essentials Products</h2>
	<div class="navbar">
				<div class="menu">
					<ul>
						<li>
...
<!-- Add to Cart end -->
	...
	<body>
		...
		<div class="container">
			...
			<!-- Display Products -->
			<?php
				$query = "SELECT * FROM table_products WHERE active_status='Yes' AND description='Essentials' ";
				...
				?>
			<div class="col-md-4">
				<form method="post" action="essentials.php?action=add&id=<?php echo $row["id"]; ?>">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="essentials.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
					<?php
