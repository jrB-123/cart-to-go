                            ...
                            if($count>0)
                            {
                                while($rows=mysqli_fetch_assoc($res))
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo SITEURL; ?>admin/password-change.php?id=<?php echo $id; ?>" class="button">Change Password</a>
                                            <a href="<?php echo SITEURL; ?>admin/admin-update.php?id=<?php echo $id; ?>" class="button">Update</a>
                                            <a href="<?php echo SITEURL; ?>admin/delete-admin.php?id=<?php echo $id; ?>" class="button-delete">Delete</a>
                                        </td>
                                    </tr>
                                    <?php
                                }
